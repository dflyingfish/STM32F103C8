...
#define PHASE_U_CURR_CHANNEL            ADC_Channel_5
#define PHASE_U_GPIO_PORT               GPIOA
#define PHASE_U_GPIO_PIN                GPIO_Pin_5
...
#define PHASE_W_CURR_CHANNEL            ADC_Channel_7
#define PHASE_W_GPIO_PORT               GPIOA
#define PHASE_W_GPIO_PIN                GPIO_Pin_7       
